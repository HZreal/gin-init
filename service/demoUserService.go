...
func NewDemoUserService(userModel *entity.TbUser, redisService *common.RedisService) *DemoUserService {
...
func (uS *DemoUserService) GetAllUser(c *gin.Context, body types.UsersFilterDTO) []types.UserDetailInfo {
...
func (uS *DemoUserService) GetUserList(c *gin.Context, query types.QueryPagination, body map[string]interface{}) (result *types.PaginationResult) {
	//
...
func (uS *DemoUserService) GetUserDetail(c *gin.Context, id uint) (userInfo types.UserDetailInfo) {
	//
...
func (uS *DemoUserService) CheckUser(loginData types.LoginData) bool {
	//
...
func (uS *DemoUserService) CreateUser(c *gin.Context, body types.UserCreateDTO) types.UserDetailInfo {
	user := entity.TbUser{
...
func (uS *DemoUserService) UpdateUser(c *gin.Context, body types.UserUpdateDTO) types.UserDetailInfo {
	id := body.Id
...
func (uS *DemoUserService) DeleteUser(c *gin.Context, id int) {
