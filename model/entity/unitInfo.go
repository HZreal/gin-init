...
type UnitInfo struct {
	...
	BasicInfo   map[string]interface{} `json:"basicInfo" gorm:"column:basic_info;type:json;comment:'基本信息';serializer:json"`
	DynamicInfo map[string]interface{} `json:"dynamicInfo" gorm:"column:dynamic_info;type:json;comment:'其他动态属性';serializer:json"`
	Extra       map[string]interface{} `json:"extra" gorm:"column:extra;type:json;comment:'扩展信息（预留存储其他信息）';serializer:json"`
...
func NewUnitInfoModel() *UnitInfo {
	return &UnitInfo{}
}
